...
<Image src="/images/cdj_setup.png" width={576} aspectRatio="16:9" alt="A top down view of the packet capture setup" format="png" />
...
### Results
<figure class="flex flex-col items-center justify-center w-full gap-2">
<Image src="/images/io_graph1.png" width={576} aspectRatio={1.41} alt="Graph showing amount of UDP packets during the capture" format="png" class="w-1/2" />
