...
<figure class="flex flex-col items-center justify-center w-full gap-2">
  ...
  />
  <figcaption class="text-sm w-full max-w-xl text-center bg-slate-50 p-2">
    Packet capture setup. Two CDJ-2000NXS2 players, a DJM-900NXS2 mixer, a
...
<figure class="flex flex-col items-center justify-center w-full gap-2">
  ...
  <figcaption class="text-sm w-full max-w-xl text-center bg-slate-50 p-2">
    Amount of UDP packets throughout the packet capture
  </figcaption>
</figure>
